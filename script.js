            ...
            if (data.memories && data.memories.length > 0) {
                ...
                for (let i = 0; i < data.memories.length; i++) {
                    ...
                    try {
                        ...
                        try {
                            // 直接保存到本地存储，跳过Firebase
                            console.log(`保存记忆到本地存储...`);
